...
// time one was edited.
//
// The frame carried a STEP NUMBER until the sections stopped being a workflow: two
// of them stand alone, so a numbered order implied a sequence nobody follows. They
// are peers now, and the frame says so by giving none of them a rank.
//
