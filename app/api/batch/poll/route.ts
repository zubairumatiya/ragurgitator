...
// USER's active jobs one step (refresh provider status; apply on completion;
// email once) and returns their fresh list. Not config-scoped — a user's jobs
// span their configs, and each applies inside its OWN config scope (resolved by
// the orchestrator).
//
